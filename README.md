...
Java Developer - backend-разработчик c опытом во frontend, проектировании и разработки серверных/десктопных приложений, API и сервисов с использованием Spring / Hibernate, а также работа с базами данных, инфраструктурой и других областях.
Опыт в создании низкоуровневых модулей защиты (AntiCheat) C++ / Java JNI, разработка инжекторов, обфускации (на Java с нативным интерфейсом JNI), шифровании данных. Небольшой опыт в рендеринге графики на OpenGL.
